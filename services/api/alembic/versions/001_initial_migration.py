...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('role', sa.Enum('admin', 'manager', 'pharmacist', 'staff', 'cashier', name='user_role'), nullable=False),
    ...
    op.create_table('warehouses',
        ...
        sa.Column('code', sa.String(50), nullable=False, unique=True),
        sa.Column('name', sa.String(255), nullable=False),
        sa.Column('type', sa.Enum('main', 'branch', 'cold_storage', 'quarantine', name='warehouse_type')),
    ...
    op.create_table('products',
        ...
        sa.Column('dosage_form', sa.Enum('tablet', 'capsule', 'syrup', 'injection', 'cream', 'ointment', 'drops', 'powder', 'suppository', name='dosage_form')),
        sa.Column('strength', sa.String(100)),
        sa.Column('drug_type', sa.Enum('prescription', 'otc', 'controlled', 'dangerous', name='drug_type')),
    ...
    op.create_table('inventory_lots',
        ...
        sa.Column('quality_status', sa.Enum('passed', 'failed', 'quarantine', 'pending', name='quality_status')),
    ...
    op.create_table('sales_orders',
        ...
        sa.Column('payment_method', sa.Enum('cash', 'credit_card', 'debit_card', 'bank_transfer', 'promptpay', 'credit', name='payment_method')),
        sa.Column('payment_status', sa.Enum('pending', 'paid', 'partial', 'refunded', name='payment_status')),
        sa.Column('paid_amount', sa.Numeric(10, 2), default=0),
        sa.Column('change_amount', sa.Numeric(10, 2), default=0),
        sa.Column('status', sa.Enum('draft', 'confirmed', 'completed', 'cancelled', name='order_status')),
    ...
    op.create_table('purchase_orders',
        ...
        sa.Column('status', sa.Enum('draft', 'sent', 'confirmed', 'partially_received', 'received', 'cancelled', name='po_status')),
    ...
    op.create_table('manufacturing_orders',
        ...
        sa.Column('status', sa.Enum('draft', 'confirmed', 'in_progress', 'completed', 'cancelled', name='manufacturing_status')),
